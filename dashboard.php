<?php include("inc/header.php");?>
    ...
    <!-- <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet"> -->
        ...
        .nav .active {
            background-color:  #81c408; /* Bootstrap primary blue */
                ...
                <div class="p-4">
                    ...
                    <form>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="Annie Mario">
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" class="form-control" id="email" placeholder="annie@example.com">
                        </div>
                        <div class="mb-3">
                            <label for="phone" class="form-label">Phone</label>
                            <input type="text" class="form-control" id="phone" placeholder="1234 567890">
                        </div>
                        <div class="mb-3">
                            <label for="address" class="form-label">Address</label>
                            <textarea class="form-control" id="address" rows="2" placeholder="7398 Smoke Ranch Road, Las Vegas, Nevada 89128"></textarea>
                        </div>
